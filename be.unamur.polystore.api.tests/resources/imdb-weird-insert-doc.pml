...
mapping rules{
	conceptualSchema.Actor(id,fullName) -> IMDB_Mongo.actorCollection(id,fullname),
	conceptualSchema.Actor(yearOfBirth,yearOfDeath) -> IMDB_Mongo.actorCollection.info.dates.fuck.f(birthyear,deathyear),
	conceptualSchema.Actor(fullName) -> IMDB_Mongo.actorCollection.movies(fullname2),

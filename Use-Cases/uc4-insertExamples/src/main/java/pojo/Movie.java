...
public class Movie extends LoggingPojo {
	...
	private java.util.List<Review> r_reviewList;
...
"dummy="+dummy +"}"; 
	...
	public java.util.List<Review> _getR_reviewList() {
		return r_reviewList;
	}

	public void _setR_reviewList(java.util.List<Review> r_reviewList) {

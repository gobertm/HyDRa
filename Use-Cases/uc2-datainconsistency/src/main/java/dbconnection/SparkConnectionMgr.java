...
public class SparkConnectionMgr {
	...
	static {
			dbPorts.put("myredis", new DBCredentials("", "localhost", "6363", "", ""));
			dbPorts.put("myproductdb", new DBCredentials("myproductdb", "localhost", "3310", "root", "password"));
			dbPorts.put("mymongo2", new DBCredentials("", "localhost", "27000", "", ""));
	}

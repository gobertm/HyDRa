...
public class insertRTests {
	...
	public static void setUp() {
		mongoClient = MongoClients.create(MongoClientSettings.builder()
				.applyToClusterSettings(builder -> builder.hosts(Arrays.asList(new ServerAddress("mymongo", 27101))))
				.build());

		try {
			connection = DriverManager.getConnection("jdbc:mysql://" + "mydb" + ":" + 3307 + "/" + "mydb", "root",
					"password");
